...
pre_refeicao = int(input ("qual meta pre refeição? "))
sensi = int(input ("qual o fator de sensibilidade? "))

if sensi <20 or sensi>60 :
    print ("valor invalido para sencibilidade")
    
else :
    qnt_glicemia = (glicemia - pre_refeicao)/sensi
    print("a quantidade de insulina é ",qnt_glicemia)
